...
def roll_dice(num_rolls, dice=six_sided):
    ...
    return ans if not has_1 else 1
    # END PROBLEM 1
...
def hefty_hogs(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    ans = player_score if opponent_score != 0 else 1
    while opponent_score > 0:
        ans = digit_fn(opponent_score % 10)(ans)
        opponent_score //= 10
    return ans % 30
    # END PROBLEM 2
...
def hog_pile(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return 0 if player_score % 10 != opponent_score % 10 else opponent_score % 10
    # END PROBLEM 4
